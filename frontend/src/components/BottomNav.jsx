...
const BottomNav = ({ step, setStep, setProfileFlow, dark }) => {
  return (
    <nav className={`fixed bottom-10 left-1/2 -translate-x-1/2 w-80 p-2 flex justify-around backdrop-blur-2xl rounded-[3rem] border-2 z-50 ${
      dark ? 'bg-slate-900/80 border-slate-800' : 'bg-white/90 border-slate-200 shadow-2xl'
    }`}>
      <button 
